...
export const createNotification = (isError, message) => {
    if (isError) {
        div.innerHTML = `
        <div role="alert" class="rounded-md border border-red-500 bg-red-50 p-4 shadow-sm max-w-md">
    ...
    div.innerHTML = `
        <div role="alert" class="rounded-md border border-green-500 bg-green-50 p-4 shadow-sm max-w-md">
        <div class="flex items-start gap-4">
            <svg
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
